...
$admin_fields_array['enabled'] = array(
    ...
    'type' => 'checkbox',
    'label' => __('Enable BOIPA Gateway', 'mmb-gateway-woocommerce'),
...
$admin_fields_array['title'] =  array(
    ...
    'desc_tip' => true,
    'default' => __('BOIPA', 'mmb-gateway-woocommerce')
);
...
$admin_fields_array['description'] =  array(
    ...
    'default' => __("Pay via BOIPA", 'mmb-gateway-woocommerce')
);

$admin_fields_array['testmode'] =  array(
    'title' => __('BOIPA Test Mode', 'mmb-gateway-woocommerce'),
    'type' => 'checkbox',
...
$admin_fields_array['api_merchant'] = array(
    ...
    'type' => 'title',
    'description' => __('In this section You can set up your merchant data for BOIPA system.', 'mmb-gateway-woocommerce')
);
...
if($show_url_fields_sandbox){
    $admin_fields_array['api_urls'] = array(
        ...
        'type' => 'title',
        'description' => __('In this section You can set up BOIPA system URLs.', 'mmb-gateway-woocommerce')
    );
    $admin_fields_array['api_test_urls'] = array(
        'title' => __('Test URLs', 'mmb-gateway-woocommerce'),
        'type' => 'title',
        'description' => __('In this section You can set up BOIPA test system URLs.', 'mmb-gateway-woocommerce')
    );
